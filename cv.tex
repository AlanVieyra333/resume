...
% \cvevent{Fullstack Software Engineer Sr}{IDS Comercial S.A. de C.V - Citibanamex}{January 2021 -- Present}{México, Remote work}
% \begin{itemize}
% 	\item Troubleshooting in web services.
% 	\item Develop web solutions with \textbf{NextJS}.
% 	\item Develop microservices with \textbf{Java Spring Boot} and \textbf{Python - DJango}.
% 	\item Develop API \textbf{RESTful} and \textbf{GraphQL}.
% \end{itemize}
...
\cvevent{Software Engineer}{EVERIS BPO MÉXICO, S. DE R.L. DE C.V. - TELCEL}{September 2019 -- December 2020}{Plaza Carzo, CDMX, México}
\begin{itemize}
	...
	% \item Use of NoSQL databases with \textbf{MongoDB} and \textbf{DynamoDB}.
	% \item Monitoring using \textbf{ElasticSearch, Logstash \& Kibana}.
\end{itemize}
